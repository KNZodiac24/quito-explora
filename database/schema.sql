-- Schema para Sistema de Eventos en Quito
...
-- admin123 -> $2b$10$rZ5aF3YLHnZ9Y5mW5vZ5xuO5mZ5mZ5mZ5mZ5mZ5mZ5mZ5mZ5mZ5m
-- user123 -> $2b$10$aB5cD6eF7gH8iJ9kL0mN1oP2qR3sT4uV5wX6yZ7aB8cD9eF0gH1i

INSERT INTO usuarios (nombre, email, password, telefono, direccion, rol) VALUES
('Administrador Sistema', 'admin@quitoexplora.com', '$2b$10$rZ5aF3YLHnZ9Y5mW5vZ5xuO5mZ5mZ5mZ5mZ5mZ5mZ5mZ5mZ5mZ5m', '0998765432', 'Centro Histórico, Quito', 'admin'),
('María González', 'maria@example.com', '$2b$10$aB5cD6eF7gH8iJ9kL0mN1oP2qR3sT4uV5wX6yZ7aB8cD9eF0gH1i', '0987654321', 'La Carolina, Quito', 'usuario'),
('Carlos Pérez', 'carlos@example.com', '$2b$10$aB5cD6eF7gH8iJ9kL0mN1oP2qR3sT4uV5wX6yZ7aB8cD9eF0gH1i', '0976543210', 'Cumbayá, Quito', 'usuario'),
('Ana Rodríguez', 'ana@example.com', '$2b$10$aB5cD6eF7gH8iJ9kL0mN1oP2qR3sT4uV5wX6yZ7aB8cD9eF0gH1i', '0965432109', 'Quicentro Sur, Quito', 'usuario');
...
('Concierto Sinfónico de Fin de Año', 'La Orquesta Sinfónica Nacional presenta un concierto especial con música clásica y contemporánea para celebrar el año nuevo.', 'Concierto', '2025-12-31 19:00:00', '19:00', '22:00', 'Teatro Nacional Sucre', 'Calle Manabí N8-131 y Guayaquil', 'Centro Histórico', 800, 25.00, 'Teatro Nacional Sucre', 'info@teatrosucre.com', 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4', false, true, 'Programado', 0, true, false),

('Festival de Comida Quiteña', 'Degusta los mejores platos tradicionales de Quito preparados por chefs reconocidos. Hornado, locro, empanadas y más.', 'Gastronomía', '2025-12-15 10:00:00', '10:00', '18:00', 'Parque Itchimbía', 'Loma de Itchimbía s/n', 'Centro', 2000, 0.00, 'Municipio de Quito', 'cultura@quito.gob.ec', 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1', true, false, 'Programado', 0, true, true),

('Ecuador Tech Summit 2025', 'El evento tecnológico más grande del año. Conferencias sobre IA, blockchain, startups y transformación digital.', 'Tecnología', '2025-12-20 09:00:00', '09:00', '18:00', 'Centro de Convenciones Metropolitano', 'Av. Amazonas y Naciones Unidas', 'Norte', 1500, 45.00, 'Ecuador Tech', 'info@ecuadortech.com', 'https://images.unsplash.com/photo-1540575467063-178a50c2df87', false, true, 'Programado', 16, true, true),

('Obra de Teatro: "Quito en el Tiempo"', 'Una obra que narra la historia de Quito a través de personajes emblemáticos. Teatro para toda la familia.', 'Teatro', '2025-12-10 20:00:00', '20:00', '22:00', 'Teatro México', 'Av. América N36-165 y Naciones Unidas', 'Norte', 300, 15.00, 'Compañía Nacional de Teatro', 'teatro@cultura.gob.ec', 'https://images.unsplash.com/photo-1503095396549-807759245b35', false, true, 'Programado', 8, true, false),

('Maratón de Quito 2025', 'Corre por las calles históricas de Quito. Categorías: 5K, 10K, 21K y 42K. Inscripciones abiertas.', 'Deportes', '2025-12-07 06:00:00', '06:00', '12:00', 'Parque La Carolina', 'Av. Eloy Alfaro y Av. República', 'Norte', 5000, 30.00, 'Federación Ecuatoriana de Atletismo', 'maraton@quito.com', 'https://images.unsplash.com/photo-1452626038306-9aae5e071dd3', false, true, 'Programado', 15, false, true),

('Exposición: Arte Contemporáneo Ecuatoriano', 'Muestra de obras de artistas ecuatorianos emergentes. Pintura, escultura y arte digital.', 'Arte', '2025-12-05 10:00:00', '10:00', '19:00', 'Centro de Arte Contemporáneo', 'Calle Montevideo y Luis Dávila', 'Centro', 500, 5.00, 'Ministerio de Cultura', 'arte@cultura.gob.ec', 'https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b', false, false, 'Programado', 0, true, false),

('Feria de Ciencias para Niños', 'Experimentos interactivos, talleres de robótica y actividades STEM para niños de 5 a 12 años.', 'Educación', '2025-12-12 09:00:00', '09:00', '16:00', 'Museo Interactivo de Ciencia', 'Calle Sincholagua y Av. Maldonado', 'Sur', 800, 0.00, 'Fundación Museos de la Ciudad', 'mic@fmcquito.gob.ec', 'https://images.unsplash.com/photo-1532094349884-543bc11b234d', true, false, 'Programado', 5, true, true),

('Noche de Jazz en Vivo', 'Disfruta de una velada con los mejores exponentes del jazz ecuatoriano e internacional.', 'Concierto', '2025-12-18 21:00:00', '21:00', '23:30', 'Jazz Club Quito', 'Calle Pinto E4-385 y Av. Amazonas', 'Centro', 150, 20.00, 'Jazz Club Quito', 'reservas@jazzclubquito.com', 'https://images.unsplash.com/photo-1415201364774-f6f0bb35f28f', false, true, 'Programado', 18, false, false),

('Feria de Emprendimientos Locales', 'Más de 100 emprendedores quiteños presentan sus productos: artesanías, ropa, joyería, alimentos orgánicos y más.', 'Otro', '2025-12-08 11:00:00', '11:00', '20:00', 'Parque La Carolina', 'Av. Eloy Alfaro y Av. Naciones Unidas', 'Norte', 3000, 0.00, 'Cámara de Comercio de Quito', 'emprendimientos@ccq.ec', 'https://images.unsplash.com/photo-1441986300917-64674bd600d8', true, false, 'Programado', 0, true, true),

('Clase de Yoga al Aire Libre', 'Sesión grupal de yoga para todos los niveles. Trae tu mat y disfruta del aire fresco en el parque.', 'Deportes', '2025-12-06 07:00:00', '07:00', '08:30', 'Parque Metropolitano', 'Av. Simón Bolívar s/n', 'Norte', 100, 0.00, 'Quito Activo', 'yoga@quitoactivo.com', 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b', true, true, 'Programado', 14, true, true),

('Torneo de Fútbol Inter-Barrios', 'Competencia deportiva entre equipos de diferentes barrios de Quito. Categorías sub-15 y adultos.', 'Deportes', '2025-12-14 08:00:00', '08:00', '17:00', 'Complejo Deportivo El Arbolito', 'Av. 6 de Diciembre y Av. Tarqui', 'Centro', 1000, 0.00, 'Liga Barrial de Quito', 'futbol@ligabarrial.ec', 'https://images.unsplash.com/photo-1574629810360-7efbbe195018', true, false, 'Programado', 0, true, true),

('Webinar: Marketing Digital 2025', 'Aprende las últimas tendencias en marketing digital, redes sociales y e-commerce. Evento virtual.', 'Tecnología', '2025-12-09 15:00:00', '15:00', '17:00', 'Evento Virtual', 'Plataforma Zoom', 'Virtual', 500, 0.00, 'Academia Digital Ecuador', 'info@academiadigital.ec', 'https://images.unsplash.com/photo-1557804506-669a67965ba0', true, true, 'Programado', 18, true, false);

-- Nota: Las contraseñas hasheadas mostradas aquí son ejemplos.
-- En producción, deberás generar el hash real usando bcrypt con:
